...
@WebServlet("/InsertLuo")
public class InsertLuo extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String insertSql = " INSERT INTO TextableLuo (id, MYUSER, EMAIL, PHONE, NUID) values (default, ?, ?, ?, ?)";
